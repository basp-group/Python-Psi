...
def fourierReduction(yn, G, Gt, Phi, Phi_t, Nd, thresholdstrategy, threshold, covmatfileexists=False):
    '''
    ...
    @param thresholdstrategy: strategy to reduce the data dimensionality
    ...
    @param threshold: if thresholdstrategy is 'value', threshold is the predefined value
                      if thresholdstrategy is 'percent', threshold is a percentage
            
    @param covmatfileexists: flag used to read available covariance matrix associated to the operator F * Phi^T
